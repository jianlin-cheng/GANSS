...
for($i=1;$i<=1;$i+=1)
{
  ...
  print SH "#!/bin/bash -l\n";
  print SH "#SBATCH -J  ga_var-$c\n";
  print SH "#SBATCH -o ga_var-$c-%j.out\n";
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=gpu python /storage/htc/bdm/jh7x3/GANSS/Deep1Dconv_ss_gan_variableLen/scripts/train_deepcov_gan_ss_variableLen.py 15 41 10  6  14  100 10 1  \$feature_dir \$outputdir\n";
