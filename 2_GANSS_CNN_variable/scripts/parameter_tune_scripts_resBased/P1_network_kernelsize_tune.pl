...
for($i=5;$i<=20;$i+=1)
{
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=gpu python /storage/htc/bdm/jh7x3/GANSS/Deep1Dconv_ss_gan_variableLen/scripts/train_deepcov_gan_ss_variableLen_residueBased.py 15 10 5 5 $i 50 10 $AA_win  \$feature_dir \$outputdir\n";
