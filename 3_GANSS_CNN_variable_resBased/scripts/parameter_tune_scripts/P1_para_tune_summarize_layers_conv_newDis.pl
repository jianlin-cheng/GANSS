...
foreach $dir (sort @subdirs)
{
  ...
  print OUT "LayerDis\t$para\tQ3\t$q3_train\n";
  print OUT "LayerDis\t$para\tSOV\t$sov_train\n";
  print OUT "LayerDis\t$para\tRecon_Err\t$loss_train\n";
  
  
  print OUT2 "LayerDis\t$para\tQ3\t$q3_val\n";
  print OUT2 "LayerDis\t$para\tSOV\t$sov_val\n";
  print OUT2 "LayerDis\t$para\tRecon_Err\t$loss_val\n";
