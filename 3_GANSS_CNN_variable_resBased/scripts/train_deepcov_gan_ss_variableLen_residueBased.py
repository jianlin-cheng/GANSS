...
from Model_training import DeepSS_1dconv_gan_variant_train_win_filter_layer_opt_V2
...
CV_dir=outputdir+'/inter'+str(inter)+'_filters'+str(nb_filters)+'_layersGen'+str(nb_layers_generator)+'_layersDis'+str(nb_layers_discriminator)+'_batch'+str(batch_size)+'_ftsize'+str(filtsize)+'_AA_win'+str(AA_win);
