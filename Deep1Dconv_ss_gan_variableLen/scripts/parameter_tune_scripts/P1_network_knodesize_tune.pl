...
for($i=30;$i<=50;$i+=2)
{
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/DeepCov_QA_revision/Training_packages_complex_rosetta/Full_proteins_training/training_main_iterative_strategy1_20171019_auto_globalonly_withoutRosetta.py 15 5 5   nadam '6' $i 50 50 3  \$datadir \$outputdir\n";
  close SH;
