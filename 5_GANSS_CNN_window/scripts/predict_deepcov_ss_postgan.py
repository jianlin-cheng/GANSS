...
from Model_evaluation import DeepSS_1dconv_gan_evaluation
...
DeepSS_1dconv_gan_evaluation(train_datafile,test_datafile,val_datafile,AA_win,discriminator_model,outputdir,feature_dir,lib_dir,True)
