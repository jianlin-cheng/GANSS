...
for($win=1;$win<=19;$win+=2)
{
  for($i=5;$i<=20;$i+=1)
  {
    ...
    print SH "#!/bin/bash -l\n";
    print SH "#SBATCH -J  ga2_kn-$c\n";
    print SH "#SBATCH -o ga2_kn-$c-%j.out\n";
    ...
    print SH "CV_dir=\$outputdir/filters10_layersGen5_layersDis5_batch1000_ftsize${i}_AA_win${win}\n\n";
    ...
    print SH "if [ -f \"\$CV_dir/model-train-discriminator-deepss_1dconv_gan-best.hdf5\" ]; then\n";
    print SH "    echo \"#################  Found model \$CV_dir/model-train-discriminator-deepss_1dconv_gan-best.hdf5\"\n";
    print SH "else\n";
    print SH "    echo \"#################  Failed to find model \$CV_dir/model-train-discriminator-deepss_1dconv_gan-best.hdf5\"\n";
    print SH "    exit\n";
    print SH "fi\n\n";
    
    
    print SH "mkdir \$CV_dir/final_gan_model_evaluation\n";
    print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/GANSS/5_GANSS_CNN_window/scripts/predict_deepcov_ss_gan.py \$CV_dir/model-train-discriminator-deepss_1dconv_gan-best.hdf5   \$feature_dir   \$CV_dir/final_gan_model_evaluation $win \n";
    ...
    print SH "cd /storage/htc/bdm/jh7x3/GANSS/5_GANSS_CNN_window/scripts/\n";   
    print SH "THEANO_FLAGS=floatX=float32,device=cpu python get_postGAN_discriminator_model.py \$CV_dir/model-train-discriminator-deepss_1dconv_gan-best.hdf5 $win 10  5  ${i}  26  3  \$CV_dir/model-train-discriminator-deepss_1dconv_postgan-best.hdf5\n";
    ...
    print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/GANSS/5_GANSS_CNN_window/scripts/predict_deepcov_ss_postgan.py \$CV_dir/model-train-discriminator-deepss_1dconv_postgan-best.hdf5   \$feature_dir   \$CV_dir/final_postgan_model_evaluation $win\n";
    print SH "cd \$CV_dir/final_gan_model_evaluation\n";
    print SH "head */*\n";
    print SH "head */* > final_gan_model_evaluation.summary\n\n";
    ...
    print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/GANSS/5_GANSS_CNN_window/scripts/finetune_deepcov_postgan_ss.py 10 5  5 $i  100 1000 $win  \$feature_dir  \$CV_dir/finetune_postgan_model_training \$CV_dir/model-train-discriminator-deepss_1dconv_postgan-best.hdf5\n";
    ...
    print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/GANSS/5_GANSS_CNN_window/scripts/predict_deepcov_ss_postgan.py \$CV_dir/finetune_postgan_model_training/model-train-discriminator-deepss_1dconv_postgan_finetune.hdf5  \$feature_dir  \$CV_dir/finetune_postgan_model_evaluation $win\n";
