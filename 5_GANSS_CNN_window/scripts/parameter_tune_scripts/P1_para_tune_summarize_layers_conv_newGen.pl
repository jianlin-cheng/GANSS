...
foreach $dir (sort @subdirs)
{
  ...
  print OUT "$win_num\tLayerGen\t$para\tQ3\t$q3_train\n";
  print OUT "$win_num\tLayerGen\t$para\tSOV\t$sov_train\n";
  print OUT "$win_num\tLayerGen\t$para\tRecon_Err\t$loss_train\n";
  
  
  print OUT2 "$win_num\tLayerGen\t$para\tQ3\t$q3_val\n";
  print OUT2 "$win_num\tLayerGen\t$para\tSOV\t$sov_val\n";
  print OUT2 "$win_num\tLayerGen\t$para\tRecon_Err\t$loss_val\n";
