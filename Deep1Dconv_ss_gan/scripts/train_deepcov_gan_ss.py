...
CV_dir=outputdir+'/filters'+str(nb_filters)+'_layersGen'+str(nb_layers_generator)+'_layersDis'+str(nb_layers_discriminator)+'_batch'+str(batch_size)+'_ftsize'+str(filtsize);
