...
DeepSS_1dconv_fixed_window_train_win_filter_layer_opt(data_all_dict,testdata_all_dict,train_datafile,test_datafile,val_datafile,CV_dir,AA_win,feature_dir,"deepss_1dconv_postgan_finetune",out_epoch,batch_size,filetsize_array,nb_filters,nb_layers_generator,nb_layers_discriminator,lib_dir,postGAN = postGAN_model)
