...
for($i=5;$i<=50;$i+=1)
{
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/Collaboration/jh7x3/DeepCov_SS_SA_project/GANSS/Deep1Dconv_ss_gan/scripts/train_deepcov_gan_ss.py $i 5 5 6 50 1000 15  \$feature_dir \$outputdir\n";
