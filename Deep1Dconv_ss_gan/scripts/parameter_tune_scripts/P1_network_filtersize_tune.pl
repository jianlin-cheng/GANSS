...
for($i=5;$i<=50;$i+=1)
{
  ...
  print SH "#!/bin/bash -l\n";
  print SH "#SBATCH -J  gan_ft-$c\n";
  print SH "#SBATCH -o gan_ft-$c-%j.out\n";
  print SH "#SBATCH -p Gpu\n";
  print SH "#SBATCH -N 1\n";
  print SH "#SBATCH -n 10\n";
  print SH "#SBATCH --mem 50G\n";
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=gpu python /storage/htc/bdm/Collaboration/jh7x3/DeepCov_SS_SA_project/GANSS/Deep1Dconv_ss_gan/scripts/train_deepcov_gan_ss.py $i 5 5 6 50 1000 15  \$feature_dir \$outputdir\n";
