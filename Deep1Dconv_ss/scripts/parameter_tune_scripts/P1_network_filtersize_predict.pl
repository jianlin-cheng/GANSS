...
for($i=6;$i<=20;$i+=2)
{
  ...
  print SH "#!/bin/bash -l\n";
  print SH "#SBATCH -J  ST1_ft_g-$c\n";
  print SH "#SBATCH -o ST1_ft_g-$c-%j.out\n";
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/DeepCov_QA_revision/Training_packages_complex_rosetta/SingleDomain_proteins_training/predict_main_iterative_strategy1_20171019_auto_globalonly_withoutRosetta.py 15 $i 5 nadam '6' 30 50 50 3  \$datadir \$outputdir\n";
