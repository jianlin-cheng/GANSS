...
for($i=1;$i<=15;$i+=1)
{
  ...
  print SH "#!/bin/bash -l\n";
  print SH "#SBATCH -J  ss_it-$c\n";
  print SH "#SBATCH -o ss_it-$c-%j.out\n";
  print SH "#SBATCH -p gpu3\n";
  print SH "#SBATCH -N 1\n";
  print SH "#SBATCH -n 1\n";
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=gpu python /storage/htc/bdm/Collaboration/jh7x3/DeepCov_SS_SA_project/Deep1Dconv_ss/lib/train_deepcov_ss.py $i 5 5   nadam '6' 100 3 \$feature_dir \$outputdir\n";
