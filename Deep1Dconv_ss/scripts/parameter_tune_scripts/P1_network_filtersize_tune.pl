...
for($i=5;$i<=20;$i+=1)
{
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=gpu python /storage/htc/bdm/Collaboration/jh7x3/DeepCov_SS_SA_project/Deep1Dconv_ss/lib/train_deepcov_ss.py 7 $i 5 nadam '6' 100 3 \$feature_dir \$outputdir\n";
