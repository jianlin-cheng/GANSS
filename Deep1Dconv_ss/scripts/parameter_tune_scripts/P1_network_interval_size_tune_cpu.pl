...
for($i=1;$i<=15;$i+=1)
{
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/Collaboration/jh7x3/DeepCov_SS_SA_project/Deep1Dconv_ss/lib/train_deepcov_ss.py $i 10 5   nadam '6' 100 3 \$feature_dir \$outputdir\n";
