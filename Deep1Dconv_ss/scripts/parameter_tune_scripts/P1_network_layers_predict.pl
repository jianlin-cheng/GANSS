...
for($i=5;$i<=15;$i+=1)
{
  ...
  print SH "#!/bin/bash -l\n";
  print SH "#SBATCH -J  ST1_ly-g-$c\n";
  print SH "#SBATCH -o ST1_ly-g-$c-%j.out\n";
  ...
  #print SH "source /group/bdm/tools/keras_virtualenv/bin/activate\n";
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/jh7x3/DeepCov_QA_revision/Training_packages_complex_rosetta/SingleDomain_proteins_training/predict_main_iterative_strategy1_20171019_auto_globalonly_withoutRosetta.py 15 5  $i nadam '6' 30 50 50 3  \$datadir \$outputdir\n";
