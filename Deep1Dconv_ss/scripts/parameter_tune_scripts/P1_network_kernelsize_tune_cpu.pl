...
for($i=5;$i<=20;$i+=1)
{
  ...
  print SH "THEANO_FLAGS=floatX=float32,device=cpu python /storage/htc/bdm/Collaboration/jh7x3/DeepCov_SS_SA_project/Deep1Dconv_ss/lib/train_deepcov_ss.py 7 5 5   nadam $i 100 3 \$feature_dir \$outputdir\n";
