...
open(OUT2,">$outputdir/validation_data_filter_summary.txt") || die "Failed to open file $outputdir/validation_data_filter_summary.txt\n";
...
foreach $dir (sort @subdirs)
{
  ...
  print OUT "Kernel\t$para\tQ3\t$q3_train\n";
  print OUT "Kernel\t$para\tSOV\t$sov_train\n";
  print OUT "Kernel\t$para\tLoss\t$loss_train\n";
